...
3. Household_index: this is for validation. It creates a household-level housing retrofit index for Cheshire & Merseyside, using household-level data, aggregated back to neighbourhood-level
